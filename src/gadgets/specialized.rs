...
pub fn batch_hash_with_domain<F: RichField + Extendable<D>, const D: usize>(
    ...
    if inputs.is_empty() {
        return Err(WireError::ValidationError(
            ValidationError::InputValidationError("Inputs array cannot be empty".to_string()),
        ));
    }
...
pub fn batch_equality_check<F: RichField + Extendable<D>, const D: usize>(
    ...
    if left_values.is_empty() {
        return Err(WireError::ValidationError(
            ValidationError::InputValidationError("Arrays cannot be empty".to_string()),
        ));
    }
...
pub fn vector_dot_product<F: RichField + Extendable<D>, const D: usize>(
    ...
    if left_values.is_empty() {
        return Err(WireError::ValidationError(
            ValidationError::InputValidationError("Vectors cannot be empty".to_string()),
        ));
    }
...
pub fn vector_sum<F: RichField + Extendable<D>, const D: usize>(
    ...
    if values.is_empty() {
        return Err(WireError::ValidationError(
            ValidationError::InputValidationError("Vector cannot be empty".to_string()),
        ));
    }
