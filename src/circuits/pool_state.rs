...
use crate::gadgets::{verify_message_signature, calculate_nullifier};
...
impl PoolStateTarget {
    ...
    pub fn new<F: RichField + Extendable<D>, const D: usize>(
        ...
        Self {
            ...
            tokenA_asset_id: (0..HASH_SIZE).map(|_| builder.add_virtual_target()).collect(),
            tokenB_asset_id: (0..HASH_SIZE).map(|_| builder.add_virtual_target()).collect(),
