...
use crate::cli::commands::{
    execute_batch_command, execute_config_command, execute_workflow_command, CommandOptions,
};
...
pub fn execute_advanced_command(command: &AdvancedCommands) -> Result<(), String> {
    match command {
        ...
        AdvancedCommands::Batch {
            ...
            match subcommand {
                BatchSubcommand::Process => execute_batch_command(
                    "process",
...
pub fn create_example_config() -> Result<(), String> {
    ...
    config
        .save(PathBuf::from("wire_config_example.json"))
