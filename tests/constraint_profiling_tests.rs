...
mod constraint_profiling_tests {
    ...
    fn profile_hash_gate_count() {
        ...
        println!(
            "Single input hash operation gate count: {}",
            single_gate_count
        );
        ...
        for &size in &input_sizes {
            ...
            println!(
                "Hash operation with {} inputs gate count: {}",
                size, gate_count
            );
            println!(
                "Average gates per input: {}",
                gate_count as f64 / size as f64
            );
        }
        ...
        println!(
            "UTXO commitment hash operation gate count: {}",
            utxo_gate_count
        );
        ...
        println!(
            "Optimized hash operation gate count: {}",
        ...
        println!(
            "Optimized UTXO hash operation gate count: {}",
            optimized_utxo_gate_count
        );
