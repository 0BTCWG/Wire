        ...
        if let Ok(proof) = result {
            ...
            match verification_result {
                Ok(_) => {
                    ...
                    println!(
                        "Verification succeeded with random signature (iteration {})",
                        i
                    );
                }
                Err(err) => {
                    ...
                    println!(
                        "Verification failed with random signature (iteration {}): {:?}",
                        i, err
                    );
                }
            }
        ...
        match result {
            Ok(proof) => {
                ...
                match verification_result {
                    Ok(_) => {
                        println!(
                            "Verification succeeded with random inputs (iteration {})",
                            i
                        );
                    }
                    Err(err) => {
                        println!(
                            "Verification failed with random inputs (iteration {}): {:?}",
                            i, err
                        );
                    }
                }
...
fn test_fuzz_merkle_proof() {
    ...
    for i in 0..iterations {
        ...
        let total_input_amount: u64 = input_utxos_data
            .iter()
        ...
        match result {
            Ok(proof) => {
                ...
                match verification_result {
                    Ok(_) => {
                        println!(
                            "Verification succeeded with random Merkle inputs (iteration {})",
                            i
                        );
                    }
                    Err(err) => {
                        println!(
                            "Verification failed with random Merkle inputs (iteration {}): {:?}",
                            i, err
                        );
                    }
                }
