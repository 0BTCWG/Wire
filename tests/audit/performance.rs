...
fn test_performance_wrapped_mint_verification() {
    ...
    let (verification_result, duration) =
        utils::measure_time(|| WrappedAssetMintCircuit::verify_proof(&proof));
...
fn test_performance_wrapped_burn_verification() {
    ...
    // Measure verification time
    let (verification_result, duration) =
        utils::measure_time(|| WrappedAssetBurnCircuit::verify_proof(&proof));
...
fn test_performance_transfer_verification() {
    ...
    // Measure verification time
    let (verification_result, duration) =
        utils::measure_time(|| TransferCircuit::verify_proof(&proof));
...
fn test_memory_usage_wrapped_mint() {
    ...
    println!(
        "Wrapped mint proof generation memory usage: {} bytes",
        memory_usage
    );
...
fn test_memory_usage_wrapped_burn() {
    ...
    // Log the memory usage
    println!(
        "Wrapped burn proof generation memory usage: {} bytes",
        memory_usage
    );
...
fn test_memory_usage_transfer() {
    ...
    // Log the memory usage
    println!(
        "Transfer proof generation memory usage: {} bytes",
        memory_usage
    );
